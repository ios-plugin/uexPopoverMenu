...
+ (void)brwView:(EBrowserView*)inBrwView presentModalViewController:(UIViewController *)modalViewController animated:(BOOL)animated;//弹出控制器
+ (BOOL)isIpad;
...
+ (int)screenWidth;//网页屏幕宽度
+ (int)screenHeight;//网页屏幕高度
...
+(UIColor*)ColorFromString:(NSString*)inColor;//将"#FFFFFF"转化为对应颜色
